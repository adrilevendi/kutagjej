                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          await mediaRecordReference.set(createMediaRecordData(
                            mediaType: 'photo',
                        ...
                        children: [
                          StreamBuilder<List<ServiceRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ServiceRecord> dropDownServiceRecordList =
                                  snapshot.data!;
                                    ...
                                    child: FlutterFlowDropDown<num>(
                                      controller:
                                          _model.dropDownValueController6 ??=
                                              FormFieldController<num>(null),
                                      options:
                                          _model.durationList('', 6)!['values'],
                                      optionLabels: _model.durationList(
                                          ' ditë', 7)!['labels'],
                                      disabled: _model.dropDownValue5 == null
                                          ? true
                                          : false,
                                      onChanged: (val) async {
                                        setState(() {
                                ...
                                onTap: () async {
                                  ...
                                  if (currentUserDocument?.firstPost != true) {
                                    await currentUserReference?.update(
                                        createUsersRecordData(firstPost: true));
                                    firstPostDiscount = 7;
                                  }
