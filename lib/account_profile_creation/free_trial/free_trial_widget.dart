                      ...
                      children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'oo9kj768' /* Reklamoni bisnesin tuaj per ve... */,
                                        ),
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '2av8dyc0' /* Te ngrini karrieren apo bisnes... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .headlineMedium
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child:Image.asset('assets/images/bizimg.jpg', width: MediaQuery.sizeOf(context).width,)
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
