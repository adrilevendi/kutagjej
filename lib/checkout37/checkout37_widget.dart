...
class Checkout37Widget extends StatefulWidget {
  const Checkout37Widget({super.key});

  @override
  State<Checkout37Widget> createState() => _Checkout37WidgetState();
}

class _Checkout37WidgetState extends State<Checkout37Widget> {
  late Checkout37Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Checkout37Model());
